...
for x in range(10):
    ...
    l='Mobile WVGA SMM-DEVIL/1.2.0 OPN-B'
...
def passx():
    ...
    print("\033[1;97m[03] \033[1;92mAUTO PASS 7 DIGIT AND MIX \033[1;96m[FAST]")
    print("\033[1;97m[04] \033[1;92mONLY MIX PASS             \033[1;96m[SLOWEST]")
    print("\033[1;97m[05] \033[1;92m8 DIGIT & MIX PASS        \033[1;96m[SLOWEST]")
    print("\033[1;97m[06] \033[1;92mOTHER & MIX PASS      \033[1;96m[SLOWEST]")
    print("\033[1;97m====================================================")
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[DEVIL] [%s]  OK: %s CP: %s'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
    except:
        pass
#---------------------[END MENU]---------------------#
